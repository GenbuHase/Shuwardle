...
function App() {
  ...
  useEffect(() => {
    if (isGameWon) {
      const WIN_MESSAGES = (t('App/Win_Messages') as Function)()
  ...
  return (
    <div className="pt-2 pb-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <StatsModal
        ...
        isGameWon={isGameWon}
        handleShare={() => {
          setSuccessAlert(t('App/Alert/GameCopied'))
      ...
      <Alert
        message={t('App/Alert/CurrentLanguage')}
        isOpen={hasChangedLanguage}
        variant="success"
      />
      <Alert
        message={t('App/Alert/NotEnoughLetters')}
        isOpen={isNotEnoughLetters}
      />
      <Alert
        message={t('App/Alert/WordNotFound')}
        isOpen={isWordNotFoundAlertOpen}
      />
      <Alert message={missingLetterMessage} isOpen={isMissingPreviousLetters} />
      <Alert
        message={(t('App/Alert/CorrectWord') as Function)(solution)}
